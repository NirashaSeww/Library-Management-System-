...
namespace lmsn
{
    public partial class Form8 : Form
    {
        ...
        {
            Con.Open();
            string myquery = "select * from returntbl";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    SqlCommand cmd = new SqlCommand("insert into returntbl values('" + textBox1.Text + "', '" + textBox2.Text + "', '" + textBox3.Text + "', '" + textBox4.Text + "', '" + textBox5.Text + "','" + textBox6.Text + "')", Con);
                    cmd.ExecuteNonQuery();
